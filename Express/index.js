...
const app=express();
const port=3000;// we can directly declair the port at the place of the 
//listen port then no need of port variable
...
// these parameter we can send from the url by similler type of url 

app.get("/:username/:id",(req,res)=>{
    let {username,id}=req.params;
    res.send(`<h1>Your request for the @${username} will be resolved and your id${id}</h1>`);
});
